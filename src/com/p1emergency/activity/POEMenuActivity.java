...
public class POEMenuActivity extends Activity implements OnClickListener,
		OnTouchListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_p1_emergency_menu);
		this.context = this;
		initUI();
	...
	public void getInfoDetails(View view) {
		...
		startActivity(new Intent(this, FakeProfileActivity.class));
	}
