...
import com.p1emergency.activity.SlidingMenu.OnCloseListener;
import com.p1emergency.activity.SlidingMenu.OnClosedListener;
import com.p1emergency.activity.SlidingMenu.OnOpenListener;
import com.p1emergency.activity.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private void onDrawBehindFade(Canvas canvas, float openPercent) {
		...
		if (alpha > 0) {
			...
			canvas.drawRect(0, 0, getBehindWidth(), getHeight(),
					mBehindFadePaint);
		}
	}
